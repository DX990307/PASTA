...
func (b R9NanoGPUBuilder) WithIOMMUCache(iommuCache *mmuTLB.TLB) R9NanoGPUBuilder {
	b.IOMMUCache = iommuCache
	return b
}

func (b R9NanoGPUBuilder) WithInnerLayer(innerLayer map[uint64]uint64) R9NanoGPUBuilder {
	b.InnerLayer = innerLayer
	return b
}

func (b R9NanoGPUBuilder) WithMiddleLayer(middleLayer map[uint64]uint64) R9NanoGPUBuilder {
	b.MiddleLayer = middleLayer
	return b
}

func (b R9NanoGPUBuilder) WithOuterLayer(outerLayer map[uint64]uint64) R9NanoGPUBuilder {
...
func (b R9NanoGPUBuilder) WithL2TLBTable(
	l2TLBTable *mem.MultiPageFinder,
) R9NanoGPUBuilder {
...
func (b *R9NanoGPUBuilder) populateExternalPorts() {
	...
	b.gpu.Domain.AddPort("L2TLB", b.l2TLB.OutsidePort)
	b.gpu.Domain.AddPort("L2TLBToIOMMU", b.l2TLB.IOMMUPort)
...
func (b *R9NanoGPUBuilder) buildL2TLB() {
	...
	if b.perfAnalyzer != nil {
		b.perfAnalyzer.RegisterComponent(b.l2TLB)
	}
}
...
func (b *R9NanoGPUBuilder) connectL2TLBtoGMMU() {
	conn := sim.NewDirectConnection(
		b.gpuName+".L2TLBToGMMU",
		b.engine, b.freq,
	)
	conn.PlugIn(b.gmmu.GetPortByName("Top"), 640)
	conn.PlugIn(b.l2TLB.GetPortByName("Bottom"), 640)
}
