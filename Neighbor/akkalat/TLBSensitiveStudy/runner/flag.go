...
var maxWGCount = flag.Uint64("max-wg", 76800,
...
var ptwCounts = flag.Int("ptw-counts", 16,
	"The database to store the visualization trace. Possible values are "+
		"sqlite, mysql, and csv.")
...
var L2TLBEntries = flag.Int("l2-tlb-entries", 512,
	"Terminate the simulation after the given number of workgroups is retired.")
var IOTLBEntries = flag.Int("io-tlb-entries", 2048,
	"Terminate the simulation after the given number of workgroups is retired.")
