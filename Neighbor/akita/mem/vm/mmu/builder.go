...
func (b Builder) WithNeighborhoodAwareWalkCoalescing(enabled bool) Builder {
	b.neighborhoodCoalescing = enabled
	return b
}
...
func (b Builder) configureInternalStates(mmu *MMU) {
	...
	mmu.neighborhoodCoalescingEnabled = b.neighborhoodCoalescing
}
