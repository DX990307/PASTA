...
func (b R9NanoGPUBuilder) WithGMMUCacheTable(
	gmmuCacheTable *mem.MultiPageFinder,
) R9NanoGPUBuilder {
...
func (b *R9NanoGPUBuilder) populateExternalPorts() {
	...
	b.gpu.Domain.AddPort("GMMUTLB", b.gmmuCache.OutsidePort)
	b.gpu.Domain.AddPort("GMMUTLBToIOMMU", b.gmmuCache.IOMMUPort)
...
func (b *R9NanoGPUBuilder) createDramControllerBuilder() dram.Builder {
	...
	memCtrlBuilder := dram.MakeBuilder().
		...
		WithTRTRS(scaleDRAMTimingAllowZero(0)).
...
func scaleDRAMTimingAllowZero(base int) int {
	if base == 0 {
		return 0
	}
	return scaleDRAMTiming(base)
}
...
func (b *R9NanoGPUBuilder) connectGMMUCachetoGMMU() {
	...
	conn.PlugIn(b.gmmuCache.GetPortByName("Bottom"), 640)
}
